      ...
      {currentSong && (
        <div style={{ position: "fixed", bottom: "60px", left: 0, right: 0, background: "#181818", borderTop: "1px solid #282828", padding: "12px 16px", zIndex: 50 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
            ...
            <div style={{ flex: 1, height: "3px", background: "#404040", borderRadius: "2px", cursor: "pointer" }} onClick={(e) => { const rect = e.currentTarget.getBoundingClientRect(); const seekTo = ((e.clientX - rect.left) / rect.width) * duration; playerRef.current?.seekTo(seekTo, true); setCurrentTime(seekTo); }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", flexShrink: 0 }}>
              ...
              <button onClick={togglePlay} style={{ width: "36px", height: "36px", borderRadius: "50%", background: "#fff", border: "none", color: "black", fontSize: "14px", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>{isPlaying ? "⏸" : "▶"}</button>
